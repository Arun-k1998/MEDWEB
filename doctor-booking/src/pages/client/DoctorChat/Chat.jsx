...
import UserChat from "../../../components/doctor/DoctorChat/DoctorChat";
import ChatBox from "../../../components/doctor/DoctorChatBox/ChatBox"
...
function Chat() {
  ...
  useEffect(() => {
    const getUser = async () => {
      doctorApi.get(`/chat/${userId}`).then((res) => {
        //userchats
