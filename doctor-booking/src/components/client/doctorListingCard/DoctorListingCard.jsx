...
function DoctorListingCard({ doctors }) {
  ...
  const hadleSlotBooking = (timeSlot, session) => {
  ...
  return (
    <div className={`${doctorsHide? '': 'items-center'} relative  flex   justify-center bg-stone-500 w-full  `}>
      {!doctorsHide && (
     ...
     <div className={`${
      ...
      <div className="w-full md:w-96 flex bg-slate-600">
